...
package com.example.android.OkHttpCertPin;
...
//                    String resultString = downloadUrl(url);
                    String resultString = downloadUrlOkHttp(url);
        ...
        private String downloadUrlOkHttp(URL url) throws Exception {
            OkHttpClient client;
            String result = null;
            try {
                int id = getResources().getIdentifier("frida", "raw","com.example.android.OkHttpCertPin");
